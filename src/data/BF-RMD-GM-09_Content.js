...
function BF_RMD_GM_09_Content() {
  return (
    <Box sx={{ padding: '20px', backgroundColor: '#f9f9f9', borderRadius: '8px' }}>
      ...
      <SectionTitle sx={{ marginTop: '40px' }}>4. 위·수탁 생산 및 서비스 계약서</SectionTitle>
      <StyledList>
      ...
      <SectionTitle sx={{ marginTop: '40px' }}>5. 위탁 생산관리</SectionTitle>
      <StyledList>
      ...
      <SectionTitle sx={{ marginTop: '40px' }}>6. 위수탁 시험관리</SectionTitle>
      ...
      <SectionTitle sx={{ marginTop: '40px' }}>7. 위수탁 서비스 (방충방서) 관리</SectionTitle>
      <StyledList>
      ...
      <SectionTitle sx={{ marginTop: '40px' }}>8. 위수탁 부적합품의 처리 및 폐기</SectionTitle>
      <StyledList>
      ...
      <SectionTitle sx={{ marginTop: '40px' }}>9. 기록 관리</SectionTitle>
      <Paragraph>

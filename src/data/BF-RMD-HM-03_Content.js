...
function BF_RMD_HM_03_Content() {
  return (
    <Box sx={{ padding: '20px', backgroundColor: '#f9f9f9', borderRadius: '8px' }}>
      ...
      <SectionTitle sx={{ marginTop: '40px' }}>3. 수세 및 소독 방법</SectionTitle>
      ...
      <SectionTitle sx={{ marginTop: '40px' }}>4. 책임과 권한</SectionTitle>
      ...
      <SectionTitle sx={{ marginTop: '40px' }}>5. 교육 및 훈련</SectionTitle>
      <StyledList>
      ...
      <SectionTitle sx={{ marginTop: '40px' }}>6. 점검 및 모니터링</SectionTitle>
      <StyledList>

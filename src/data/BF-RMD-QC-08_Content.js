...
// 3.2.3 시약 관리에 관한 문서화, 실행 및 유지를 관장한다.
// 3.2.4 시약 관리와 관련된 변경사항을 검토하고 승인한다.

// 3.3 품질관리담당자
// 3.3.1 정기적으로 시약 및 시액의 유효기간 경과 여부, 변질 여부 및 잔량 등을 확인한 후, 구매 또는 폐기 조치를 취한다.
// 3.3.2 시약 및 시액의 보관 및 관리를 수행하고, 적절한 보관조건하에서 보관한다.
...
// 5.2 별도의 규정이 없는 한 시약 및 시액은 공급업체가 제공한 원용기에 보관하고, 냉장보관 시약 및 시액은 냉장고에 보관한다. 

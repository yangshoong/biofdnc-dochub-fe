...
// 4.2.2 정제수 품질 기준 설정 및 변경을 검토하고 승인한다.
// 4.2.3 정제수 시험 관련 문서 및 기록 관리를 총괄한다.
...
// 4.4 품질관리담당자
// 4.4.1 정제수 시험을 실시하고 결과를 기록한다.
// 4.4.2 정제수 시험 결과를 품질보증책임자에게 보고한다.
// 4.4.3 시험 기기 및 시약의 관리를 담당한다.

// 4.5 제조담당자
// 4.5.1 정제수 제조관리 및 제조장치의 유지보수 관리를 실시한다.
// 4.5.2 정제수 사용시설의 위생관리를 실시한다.

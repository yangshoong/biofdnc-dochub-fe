...
// 1) 제조 및 제품 관련 용어
// 1.2.1 "제조": 원료 칭량부터 포장 및 표시까지의 일련의 작업
// 1.2.2 "원료": 제품 제조에 사용되는 물질
// 1.2.3 "자재": 제품의 용기, 포장재 등 제조에 사용되는 물품
// 1.2.4 "원부자재": 화장품 원료 및 부자재
// 1.2.5 "반제품": 최종 제품이 되기 위해 추가적인 제조공정이 더 필요한 중간 단계의 제품
// 1.2.6 "제품": 모든 제조공정이 완료된 최종 제품
// 1.2.7 "제조단위": 균질성을 갖는 일정량의 제품
// 1.2.8 "제조번호": 제조 단위를 식별하는 고유 번호
// 1.2.26 "부자재": 제품 포장에 사용되는 재료

// 2) 품질 관리 및 보증 관련 용어
// 1.2.9 "부적합품": 규정된 요구사항을 충족하지 않는 원료, 자재, 반제품 또는 제품
// 1.2.10 "재작업": 부적합 제품을 규정된 품질 요구사항에 적합하도록 다시 가공하는 작업
// 1.2.11 "품질보증": 제품이 적합 판정 기준을 충족하도록 보장하는 모든 계획된 활동
// 1.2.12 "일탈": 정해진 기준을 벗어난 행위
// 1.2.13 "기준일탈": 규정된 적합 판정 기준에 맞지 않는 결과
// 1.2.27 "적합 판정 기준": 시험 결과의 허용 범위

// 3) 고객 관리 및 제품 회수 관련 용어
// 1.2.14 "불만": 제품 품질에 대한 외부의 부정적 의견
// 1.2.15 "회수": 품질 문제로 인해 판매된 제품을 수거하는 활동

// 4) 위생 및 오염 관련 용어
// 1.2.16 "오염": 제품의 화학적, 물리적, 미생물학적 문제 발생
// 1.2.17 "청소": 표면의 먼지 등을 제거하는 작업
// 1.2.32 "위생관리": 오염물 제거를 위한 작업

// 5) 설비 및 유지보수 관련 용어
// 1.2.18 "유지관리": 건물과 설비의 적절한 상태 유지를 위한 작업
// 1.2.19 "주요 설비": 제품 품질에 영향을 미치는 필수 설비
// 1.2.20 "교정": 측정기기의 정확도 확인 및 조정

// 6) 외부 위탁 및 감사 관련 용어
// 1.2.21 "수탁자": 외부에서 작업을 대신 수행하는 주체
// 1.2.23 "감사": 제조 및 품질관리의 적합성을 조사하는 활동
// 1.2.25 "내부감사": 자체 업무담당자에 의한 제조 및 품질관리 조사

// 7) 공정 및 변경 관리 관련 용어
// 1.2.22 "공정관리": 제조공정 중 품질을 모니터링하고 조정하는 작업
// 1.2.24 "변경관리": 제조 및 품질관리 활동의 계획된 변경

// 8) 기타 용어
// 1.2.28 "소모품": 청소, 위생, 유지 작업에 사용되는 물품
// 1.2.29 "관리": 적합 판정 기준 충족 여부 검증
// 1.2.30 "제조소": 제품, 반제품 제조 장소
// 1.2.31 "건물": 제품 관련 활동이 이루어지는 물리적 공간
// 1.2.33 "출하": 제품을 제조소 외부로 운반하는 활동
// 1.2.34 "폐기": 부적합품을 재작업해도 회복이 불가능하여 본래의 용도로 사용할 수 없게 하는 활동
// 1.2.35 "반품": 부적합 원료 또는 자재를 공정에 사용할 수 없어 납품업체로 되돌려 보내는 활동
...
// 2.2.2.품질보증책임자
// 2.2.2.1.품질보증 업무 총괄
// 2.2.2.2.문서화, 실행 및 유지 관장, 변경관리 검토 및 승인
...
// 5.6.4.불만 처리 기한을 준수하고, 처리 결과를 고객에게 회신한다.
// 5.6.5.불만 처리의 후속조치 및 재발 방지 대책을 수립하고 실행한다.

...
function BF_RMD_GM_06_Content() {
  return (
    <Box sx={{ padding: '20px', backgroundColor: '#fff', borderRadius: '8px' }}>
      ...
      <Paragraph>
        본 규정은 당사의 품질경영시스템의 적합성 및 유효성을 평가하기 위해 실시하는 내부심사에 대하여 적용한다.
      </Paragraph>
      ...
      <StyledList>
        <StyledListItem>3.1.1 내부심사 결과에 대한 최종 검토 및 승인</StyledListItem>
      </StyledList>
      ...
      <StyledList>
        ...
        <StyledListItem>3.2.6 새로운 정보에 따른 내부심사 규정의 개정</StyledListItem>
      </StyledList>
      ...
      <StyledList>
        <StyledListItem>3.4.1 내부심사 수행 및 보고서 작성</StyledListItem>
        <StyledListItem>3.4.2 시정조치 이행 및 확인</StyledListItem>
      </StyledList>

      <Divider sx={{ marginY: '50px' }} />
      
      <SectionTitle>4. 내부심사 관리체계</SectionTitle>
      <StyledList>
        <StyledListItem>4.1 당사의 품질경영체계가 계획된 사항에 부합하는지를 주기적으로 검증하기 위하여 내부심사를 계획 및 실행한다.</StyledListItem>
        <StyledListItem>4.2 감사원은 품질경영 교육 및 내부심사원 과정 교육 이수자 또는 경력자로서, 감사대상과 독립적인 자를 선임한다.</StyledListItem>
      ...
      <SectionTitle>5. 내부심사 계획 수립</SectionTitle>
      <StyledList>
        <StyledListItem>5.1 품질보증책임자는 "연간감사계획서"를 매년 12월 말까지 수립하여 각 부서에 통보한다.</StyledListItem>
        <StyledListItem>5.2 품질보증책임자는 연간감사계획에 따라 해당 시점에 여유를 두고 "내부심사 일정계획서"를 작성하여 회사 내에 공고한다.</StyledListItem>
      ...
      <SectionTitle>6. 내부심사의 절차</SectionTitle>
      <SubsectionTitle>6.1 준비단계</SubsectionTitle>
      <StyledList>
        <StyledListItem>6.1.1 품질보증책임자는 내부품질감사 1주일 전에 감사일정, 목적, 대상부서를 선정한다.</StyledListItem>
        <StyledListItem>6.1.2 내부심사 항목을 선정하여 "감사 체크 리스트"를 준비한다.</StyledListItem>
        <StyledListItem>6.1.3 내부심사 일정 계획을 사내에 공지한다.</StyledListItem>
      </StyledList>
      ...
      <SectionTitle>7. 특별 내부심사</SectionTitle>
      ...
      <StyledList>
        <StyledListItem>8.1 정기 및 특별 내부품질감사 시 발견한 부적합사항은 평가단계를 거쳐 "내부심사 보고서"에 그 내용을 작성하여 피감사 부서장의 확인을 받고 처리한다.</StyledListItem>
      ...
      <StyledList>
        <StyledListItem>10.1 연간 내부심사 계획서</StyledListItem>
        <StyledListItem>10.2 내부심사 일정 계획서</StyledListItem>
        <StyledListItem>10.3 내부심사 보고서</StyledListItem>
        <StyledListItem>10.4 시정 및 예방조치 요구서</StyledListItem>
        <StyledListItem>10.5 내부심사점검표</StyledListItem>
      </StyledList>
    </Box>
  );
}

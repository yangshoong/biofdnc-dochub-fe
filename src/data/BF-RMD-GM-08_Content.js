...
// 5.1.3 불만 사항을 접수한 업무담당자는 ERP 시스템에 파악한 내용을 기록한다.
...
// 8. 불만처리 결과의 회신
// 8.1 업무담당자는 상기 6항에 따른 원인 조사 결과 및 불만 처리대책을 품질보증부서로 부터 전달받아 해당 고객에게 회신한다.

// 9. 불만처리의 후속조치
// 9.1 업무담당자는 불만처리에 관련된 모든 정보를 ERP 시스템에 기록하고 관리한다. 
// 9.2 품질보증책임자는 고객 불만에 대한 재발 방지 대책이 계획대로 실행되었는지 확인한다.

// 10. 기록 및 문서보관
// 10.1 본 규정에 의해 작성된 기록은 ERP 시스템에 4년간 보관한다.
// 10.2 불만처리 관련 문서의 작성, 검토, 승인, 배포, 개정은 "문서 및 자료관리 규정"에 따른다.

...
//   return (
//     <Box sx={{ padding: '20px', backgroundColor: '#f9f9f9', borderRadius: '8px' }}></Box>
// 1. 목적
...
// 4.2 품질보증책임자
// 4.2.1 품질보증 업무 총괄
// 4.2.2 문서화, 실행 및 유지 관장, 변경관리 검토 및 승인
// 4.2.3 부적합품 처리 방안 결정
// 4.2.4 시정 및 예방 조치 관리
// 4.2.5 원료, 부자재, 반제품, 제품의 품질관리 총괄
// 4.2.6 품질관리 기준서 및 제품 표준서 관리
// 4.2.7 시험 성적서 발행 및 시험담당자 지정
// 4.2.8 시험 항목, 기준 및 방법 검토 및 설정
// 4.2.9 시험결과 확인 및 적부 판정
// 4.2.10 국내외 화장품법규 파악 및 준수
// 4.2.11 품질관리 계획 수립 및 실시
// 4.2.12 검사, 측정 및 시험기기 관리
// 4.2.13 시정, 예방조치 및 불만처리 주관
// 4.2.14 내부감사 계획 및 실시
// 4.2.15 교육훈련 총괄관리
// 4.2.16 협력업체 평가 및 선정
// 4.2.17 기록관리, 문서관리, 변경관리 총괄
// 4.2.18 위수탁생산 및 서비스 관리
// 4.2.19 회수 및 반품처리, 폐기물 처리 총괄
// 4.2.20 일탈관리, 안정성 시험 총괄

// 4.3 제조생산책임자
// 4.3.1 제조 및 생산 업무 총괄
// 4.3.2 제조공정 및 설비 변경에 대한 평가
// 4.3.3 부적합품 처리 방안 강구
// 4.3.4 제조 공정관리 및 개선
// 4.3.5 제조설비 유지관리 및 구매 계획
// 4.3.6 제조관련 문서 관리
// 4.3.7 반제품 및 제품 관리
// 4.3.8 원료 및 부자재 관리
// 4.3.9 작업장 및 작업원 위생관리
// 4.3.10 제조번호 부여 관리
// 4.3.11 공급업체 평가작성 및 관리
// 4.3.12 부적합품 관리

// 4.4 업무담당자
// 4.4.1 소속 부서별 업무 수행
// 4.4.2 관련 규정 및 절차 준수
// 4.4.3 업무 수행 중 발생한 문제점 보고
// 4.4.4 품질 향상을 위한 제안 및 개선 활동 참여

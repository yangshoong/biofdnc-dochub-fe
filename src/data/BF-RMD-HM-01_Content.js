...
function BF_RMD_HM_01_Content() {
  return (
    <Box sx={{ padding: '20px', backgroundColor: '#f9f9f9', borderRadius: '8px' }}>
      ...
      <SectionTitle sx={{ marginTop: '40px' }}>4. 방충관리 방법</SectionTitle>
      <StyledList>
      ...
      <SectionTitle sx={{ marginTop: '40px' }}>5. 방서관리</SectionTitle>
      <StyledList>
      ...
      <SectionTitle sx={{ marginTop: '40px' }}>6. 방충, 방서 시설의 점검 및 관리</SectionTitle>
      ...
      <SectionTitle sx={{ marginTop: '40px' }}>7. 기록 및 문서보관</SectionTitle>
      <StyledList>

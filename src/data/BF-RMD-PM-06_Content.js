...
// 4.7.4 제조 완료 시 "제품 관리 규정"에 따라 처리한다.
...
// 4.12 제품의 식별 및 추적성 관리
// 4.12.1 "제품식별 및 추적성 관리 규정"에 따라 제품의 식별 및 추적이 가능하도록 관리한다.

// 4.13 변경관리
// 4.13.1 제조공정 또는 설비의 변경이 필요한 경우 "변경관리 규정"에 따라 처리한다.
